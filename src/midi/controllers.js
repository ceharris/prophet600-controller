...
const controllers = {
  ...
  [Names.LFO_DEST_TARGET]:                  new StepController(59, 6, lfoDestinationModeTransformer),
  [Names.LFO_DEST_FREQUENCY]:               new StepController(59, 6, lfoDestinationModeTransformer),
  [Names.LFO_DEST_PULSE_WIDTH]:             new StepController(59, 6, lfoDestinationModeTransformer),
  [Names.LFO_DEST_FILTER]:                  new StepController(59, 6, lfoDestinationModeTransformer),
  [Names.LFO_DEST_AMPLIFIER]:               new StepController(59, 6, lfoDestinationModeTransformer),
  ...
  [Names.PERFORMANCE_BEND_WHEEL_RANGE]:     new StepController(67, 4),
  [Names.PERFORMANCE_BEND_WHEEL_TARGET]:    new StepController(68, 2),
  [Names.PERFORMANCE_MOD_WHEEL_RANGE]:      new StepController(69, 3),
